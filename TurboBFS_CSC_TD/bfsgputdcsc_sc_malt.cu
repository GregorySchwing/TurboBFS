...
/*************************prototype kernel*************************************/
__global__ void spMvUgCscScKernel_b (int *CP_d,int *IC_d,int *ft_d,int *f_d,int *m_d,
				   float *sigma_d,int j,int r,int n);
/******************************************************************************/
...
int  bfs_gpu_td_csc_sc_malt (int *IC_h,int *CP_h,int *S_h,int *m_h,float *sigma_h,int r,
  ...
  printf("\nbfsgputdcsc_wa_malt::d = %d,t_sum=%lfms \n",d,t_sum);
  ...
  int print_t = 1;
  if (print_t){
    printf("bfsgputdcsc_wa_malt::time f <-- fA d = %lfms \n",t_spmv_t/repetition);
    printf("bfsgputdcsc_wa_malt::time time bfs functions d = %lfms \n", t_bfsfunctions_t/repetition);
    printf("bfsgputdcsc_wa_malt::average time BFS d = %lfms \n",t_bfs_avg);
  }
 ...
 */
__global__
void spMvUgCscScKernel_b (int *CP_d,int *IC_d,int *ft_d,int *f_d,int *m_d,
			float *sigma_d,int d,int r,int n){
